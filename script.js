const mealPlans = {
    ...
    "70-100kg+": {
        ...
        gain_weight: [
            ...
            { name: "Fried Chicken with Mac and Cheese", img: "fried-chicken.jpg", calories: 900 }
        ],
        maintain: [
            { name: "Beef Stir-fry with Broccoli", img: "beef-stirfry.jpg", calories: 500 },
            { name: "Cobb Salad", img: "cobb-salad.jpg", calories: 450 },
            { name: "Vegetable Fried Rice", img: "vegetable-fried-rice.jpg", calories: 500 }
        ]
    }
};
...
document.getElementById('mealPlanForm').addEventListener('submit', function(event) {
    ...
    const weightRange = document.getElementById('weightRange').value; // New weight range input
    ...
    // Display new meal suggestions with calorie counts
